#!/bin/bash
# =============================================================================
# Apache Reverse Proxy Installation and Configuration Script
# =============================================================================
# This script configures Apache as a reverse proxy for pgAdmin with a local
# domain name (e.g., postgresql.local) and optional SSL support.
#
# Prerequisites:
...
#
# Features:
# - Configures Apache as reverse proxy for pgAdmin
...
display_banner() {
    echo -e "${GREEN}"
    echo "============================================================================="
    echo "        Apache Reverse Proxy Setup for pgAdmin"
    echo "============================================================================="
    echo -e "${NC}"
    log_info "Starting Apache reverse proxy installation..."
}
...
load_config() {
    ...
    if [ -z "${PGADMIN_BACKEND:-}" ]; then
        log_error "PGADMIN_BACKEND is not set in configuration file"
        exit 1
    fi
...
enable_apache_modules() {
    ...
    local modules=("proxy" "proxy_http" "headers" "rewrite")
...
# =============================================================================
# Apache Reverse Proxy Configuration for pgAdmin
...
<VirtualHost *:${HTTPS_PORT:-443}>
    ...
    ProxyPass / ${PGADMIN_BACKEND}
    ProxyPassReverse / ${PGADMIN_BACKEND}
...
verify_proxy() {
    log_info "Verifying reverse proxy configuration..."
    ...
    log_success "Reverse proxy verification completed successfully"
}
...
display_connection_info() {
    echo ""
    echo -e "${GREEN}=============================================================================${NC}"
    echo -e "${GREEN}        Apache Reverse Proxy Installation Completed Successfully!${NC}"
    echo -e "${GREEN}=============================================================================${NC}"
    echo ""
...
main() {
    ...
    log_success "Apache reverse proxy setup completed successfully!"
}
